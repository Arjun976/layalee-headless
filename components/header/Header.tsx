...
export default function Header({ themeSettings, navMenus }: HeaderProps) {
  ...
  // Extract header strip data
  const enableHeaderStrip = themeSettings?.header_strip_items?.enable_header_strip !== '0';
  const stripItems = themeSettings?.header_strip_items?.strip_items || [];
  ...
  const defaultStripItems = [
    {
      text: "Premium Indoor & Outdoor Planters",
      icon_svg: `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_280_4970)">
              <mask id="mask0_280_4970" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="18" height="18">
                <path d="M17.335 17.335V0.665039H0.665039V17.335H17.335" fill="white" stroke="white" stroke-width="1.33" />
              </mask>
              <g mask="url(#mask0_280_4970)">
                <path d="M12.8338 11.5605C10.7165 13.6778 7.28369 13.6778 5.1664 11.5605L4.20801 6.7684L7.08326 7.72683L9.00009 4.85157L10.9169 7.72683L13.7922 6.7684L12.8338 11.5605Z" stroke="#F5F3EF" stroke-width="1.33" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M17.2969 9C17.2969 13.5822 13.5822 17.2969 9 17.2969C4.41777 17.2969 0.703125 13.5822 0.703125 9C0.703125 4.41777 4.41777 0.703127 9 0.703127C13.5822 0.703127 17.2969 4.41777 17.2969 9Z" stroke="#F5F3EF" stroke-width="1.33" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              </g>
            </g>
            <defs>
    ...
    {
      text: "UAE Delivery Available",
      icon_svg: `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_280_4984" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="18" height="18">
              <path d="M17.335 17.335V0.665039H0.665039V17.335H17.335" fill="white" stroke="white" stroke-width="1.33" />
            </mask>
            <g mask="url(#mask0_280_4984)">
              <path d="M12.8672 13.9219H11.0742V4.4297H14.9716C15.4173 4.4297 15.8149 4.70989 15.9648 5.12966L17.4727 9.35157V13.9219H15.6797" stroke="#F5F3EF" stroke-width="1.33" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M5.09766 13.9219H11.0742V3.72657C11.0742 3.1441 10.602 2.67188 10.0195 2.67188H1.58203C0.999562 2.67188 0.527344 3.1441 0.527344 3.72657V13.9219H2.28516" stroke="#F5F3EF" stroke-width="1.33" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M15.6797 13.9219C15.6797 14.6985 15.0501 15.3282 14.2734 15.3282C13.4968 15.3282 12.8672 14.6985 12.8672 13.9219C12.8672 13.1453 13.4968 12.5157 14.2734 12.5157C15.0501 12.5157 15.6797 13.1453 15.6797 13.9219Z" stroke="#F5F3EF" stroke-width="1.33" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M5.09766 13.9219C5.09766 14.6985 4.46808 15.3282 3.69141 15.3282C2.91473 15.3282 2.28516 14.6985 2.28516 13.9219C2.28516 13.1453 2.91473 12.5157 3.69141 12.5157C4.46808 12.5157 5.09766 13.1453 5.09766 13.9219Z" stroke="#F5F3EF" stroke-width="1.33" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            </g>
          </svg>`
    }
  ];

  const activeStripItems = stripItems.length > 0 ? stripItems : defaultStripItems;
    ...
    <header className="w-full">
      ...
      {enableHeaderStrip && (
        <div className="hidden xl:flex bg-[#507661] justify-center items-center min-h-[24px] p-2.5 gap-5">
          {activeStripItems.map((item, index) => (
            <React.Fragment key={index}>
              ...
              <div className="flex items-center gap-[11px]">
                ...
                <p className="text-[#E9EDEB] font-sans text-base font-normal leading-[22.4px]">
      ...
      <div className="sticky top-0 z-[1000] w-full bg-white ">
        <div className="flex justify-between items-center py-3 px-5 md:py-4 md:px-10 xl:py-3 xl:max-w-[1200px] 2xl:max-w-[1760px] 3xl:max-w-[1760px] 3xl:px-0 mx-auto w-full max-h-[59px] md:max-h-[72px] lg:min-h-[100px]">
          {/* Brand Logo */}
          {logoSvg ? (
            <Link
              href="/"
              className="block h-10 lg:h-[74px] w-auto [&>svg]:h-full [&>svg]:w-auto [&>svg]:block [&>svg]:object-contain"
              dangerouslySetInnerHTML={{ __html: logoSvg }}
            />
          ) : (
            <Link href="/" className="block">
              <img src="/Logo.png" alt="Layalee Logo" className="h-10 lg:h-[74px] w-auto block object-contain" />
            </Link>
          )}
          ...
          <div className="mobile-logo">
            {logoSvg ? (
              <Link
                href="/"
                onClick={closeMenu}
                className="block h-10 w-auto [&>svg]:h-full [&>svg]:w-auto [&>svg]:block [&>svg]:object-contain"
                dangerouslySetInnerHTML={{ __html: logoSvg }}
              />
            ) : (
