...
export default function ProductCatalog({ initialProducts, categories }: ProductCatalogProps) {
  ...
  return (
    <section className="py-12 md:py-16 xl:py-20 bg-[#F5F3EF]">
      <div className="flex flex-col gap-10 md:gap-14 px-5 md:px-[30px] xl:px-10 mx-auto w-full xl:max-w-[1200px] 2xl:max-w-[1400px] min-[1600px]:box-content min-[1600px]:!max-w-[1540px]">
        
        {/* Sleek Filter & Search Bar */}
        <div className="flex flex-col gap-6 bg-white p-6 md:p-8 rounded-[4px] border border-[#2C322D]/5 shadow-[0_4px_24px_rgba(44,50,45,0.02)]">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-between border-b border-[#2C322D]/10 pb-4">
            <span className="text-[#2C322D] font-['Funnel_Display',sans-serif] text-xl font-normal">
              Showing {processedProducts.length} Planters
            </span>
          </div>
